      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-5">
        ...
        <div>
          ...
          <div className="space-y-0.5">
            ...
            {currentUser && (currentUser.role.name === "Super Admin" || currentUser.role.id === "role_super_admin" || currentUser.role.id === "role_admin" || currentUser.role.permissions.includes("user:manage")) && (
              <button
